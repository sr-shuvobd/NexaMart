      ...
      <div className="w-full max-w-[400px] animate-slide-up">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            {isSeller ? "Start selling to thousands of customers." : "Join thousands of users discovering great products."}
          </p>
        </div>

        <div className="card-base p-6 md:p-8 relative overflow-hidden bg-white/70 dark:bg-[#0a0a0a]/70 backdrop-blur-xl transition-all duration-300">
          <div className="absolute top-0 left-0 w-32 h-32 bg-teal-500/10 rounded-full blur-[40px] pointer-events-none" />

          {/* Shopper / Seller toggle */}
          <div className="relative z-10 mb-6 flex bg-neutral-100 dark:bg-neutral-900 rounded-lg p-1">
            <button
              type="button"
        ...
        <p className="text-center mt-6 text-sm text-neutral-500">
          ...
          <Link href="/login" className="font-medium text-neutral-900 dark:text-white hover:underline underline-offset-4">
            Sign in
          </Link>
        </p>
      </div>
