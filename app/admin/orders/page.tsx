    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-neutral-500">Track and manage customer orders.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="card-base p-16 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-neutral-500 max-w-sm mb-6">No orders match your search criteria or the store has no orders yet.</p>
        </div>
      ) : (
